...
function strip_niqqud() {
  rep={'\n':'","','\u05B0':'','\u05B1':'','\u05B2':'','\u05B3':'','\u05B4':'','\u05B5':'','\u05B6':'','\u05B7':'','\u05B8':'','\u05B9':'','\u05BB':'','\u05BC':'','\u05BF':'','\u05C1':'','\u05C2':'',
       ...
       '\u202B':''}; // RTL embedding
  document.getElementById("out").value=document.getElementById("inp").value.replace(
...
<p><input type="button" onclick="strip_niqqud();" value="Strip Niqqud" /> <input type="button" onclick="fix_sofit(inp.value);" value="Fix Sofit" /></p>
