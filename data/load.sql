...
CREATE TABLE tables (
    ...
    pre_s1m     VARCHAR(50) NOT NULL,
    pre_s1f     VARCHAR(50) NOT NULL,
    pre_s2m     VARCHAR(50) NOT NULL,
    pre_s2f     VARCHAR(50) NOT NULL,
    pre_s3m     VARCHAR(50) NOT NULL,
    pre_s3f     VARCHAR(50) NOT NULL,
    pre_p1m     VARCHAR(50) NOT NULL,
    pre_p1f     VARCHAR(50) NOT NULL,
    pre_p2m     VARCHAR(50) NOT NULL,
    pre_p2f     VARCHAR(50) NOT NULL,
    pre_p3m     VARCHAR(50) NOT NULL,
    pre_p3f     VARCHAR(50) NOT NULL,
